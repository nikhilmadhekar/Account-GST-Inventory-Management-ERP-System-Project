...
import SearchOperation.SaleItemNameSearchFilter;
import SearchOperation.SalePartyNameSearchFilter;
...
import sale.EmptyRowIdentifier;
import sale.SaleDB;
...
public class NewSaleFrame extends javax.swing.JFrame {
    ...
    public NewSaleFrame() {
        super("NEW SALE  Login By"+" "+LoginFrame.uname);
        initComponents();
    ...
    ((DefaultTableCellRenderer)jTable3.getTableHeader().getDefaultRenderer()).setHorizontalAlignment((int) TOP_ALIGNMENT);
       ...
       String gstnum= new SaleDBOperation().getHomeCompanyGST();
...
String invoicevalidstr=new ValidateInvoice().isValidInvoiceNO(invoicenum);
        ...
        {
             JOptionPane.showMessageDialog(null, "Please Select the Sale type");
        }
...
//        }
            ...
            {
                JOptionPane.showMessageDialog(null, "Sale Table  Can not be Empty");
            }
            
            else
            {
                
                if(new SaleDB().isInvoiceExisted(invoicenum))
                {
                ...
                else
                {
                    ...
                    SaleDBOperation sd=new SaleDBOperation();
              ...
              StockDBOperation sdd=new StockDBOperation();
                    
              ArrayList stockinfo=sdd.getAllStockinfo();       
            ...
            for(int i=0;i<uniqueitems.size();i++)
        {
           ...
           // System.out.println("temp "+temp);
             ...
             String iname1=(String) temp.get(0);
              ...
              for (int j = 0; j <stockinfo.size(); j++) 
              {
                ...
                if(iname1.equals(iname2))
                {
                    ...
                    finalquantity=Math.abs(Double.parseDouble(previouquan)-finalquantity);     
                    String fquantity=Double.toString(finalquantity);
                    
                    sdd.updateStockinfo(iname2, (String) temp.get(2), fquantity, unit);
                }
              }
             ...
             sd.addSearchSaleInfo(partyname, partygst, invoicenum, invoicedate, totalinamount, totaltaxamount, totalcgst, totalsgst, totaligst, status, LoginFrame.uname, LoginFrame.date);   
             
               
 JOptionPane.showMessageDialog(null,"Sale Entry Successfully Stored");
...
model2.setRowCount(0);
        ...
        NewSaleFrame l = new NewSaleFrame();
        l.setSize(d);
        l.revalidate();
        l.setVisible(true);
    ...
    public void openItemSelectionFrame()
    {
        if(mouseclickedstatus!=1)
        {
         ...
         if (selcol == 0) 
            ...
            {
                      SaleItemNameSearchFilter.existedItem=itemname;
                    itemselectionframevalue = 1;
                    SaleItemNameSearchFilter.row = row;
                    SaleItemNameSearchFilter.col = selcol;
                    SaleItemNameSearchFilter l = new SaleItemNameSearchFilter();
                    l.setVisible(true);
                    l.setSize(375, 475);
...
model2.setRowCount(0);
    ...
    private void jTextField5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField5KeyPressed
         ...
         if(partyselectionframevalue==0)
        {
            ...
            SalePartyNameSearchFilter l = new SalePartyNameSearchFilter();
            l.setVisible(true);
            l.setSize(300, 500);
...
//                   System.out.println("Row Count: "+row);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewSaleFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
