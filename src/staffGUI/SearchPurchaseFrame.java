...
public static String logoutdatetime=new CurrentDateTime().getDateTime();
    ...
    public SearchPurchaseFrame() {
        ...
        super ("SEARCH PURCHASE RFR Login By"+" "+LoginFrame.uname);
        initComponents();
        ...
        ArrayList searchpurinfo=new PurchaseDBOperation().getAllSearchPurchaseInfo();
        ...
        JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) 
         {
            ...
            {
                String tt=(String)selectedinvoicenum.get(i);
               new PurchaseDBOperation().deleteInvoiceNumbers(tt);
               
            }
                
               JOptionPane.showMessageDialog(null," All Sleected Rows are  Deleted Successfully !");
                  this.dispose();
        Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
