...
public class SalePartyNameSearchFilter extends javax.swing.JFrame {

   
    public SalePartyNameSearchFilter() {
        initComponents();
        ((DefaultTableCellRenderer)jTable1.getTableHeader().getDefaultRenderer())
           .setHorizontalAlignment((int) TOP_ALIGNMENT);
        
         int rowheight=30; 
         ArrayList partylist = new SaleDBOperation().getPartyNames();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        NewSaleFrame.jLabel2.setText(jTextField1.getText().toUpperCase());
        String pname=jTextField1.getText();
        NewSaleFrame.jTextField5.setText(pname);
        ArrayList partyinfo= new SaleDBOperation().getPartyInfo(pname);
     //   ArrayList centers=new PurchaseDBOperation().getCostCentersNames();
       ...
       if(gst.equals("Unregistered")) 
       {
           ...
           String bankinfo="";
            ...
            if(bankdetails.equals("No Bank Info"))
            {
                ...
                NewSaleFrame.jLabel14.setText(bankinfo);
                NewSaleFrame.jLabel5.setText("<html><div style='text-align: left;'>" + (String) partyinfo.get(0) + "<br>" + (String) partyinfo.get(1) + "<br>" + (String) partyinfo.get(2) + "<br>" + (String) partyinfo.get(3) + "</div></html>");
                NewSaleFrame.jLabel6.setText((String) partyinfo.get(4));
      ...
      //  NewPurchaseFrame.jComboBox4.setModel(new DefaultComboBoxModel<String>((String[]) centers.toArray(new String[0])));
       // NewPurchaseFrame.jComboBox3.setSelectedItem(gst);
        NewSaleFrame.jLabel14.setText("<html><div style='text-align: left;'>"+"Bank Name: "+bstr[0]+"<br>"+"Account Number: "+bstr[1]+"<br>"+"IFSC Code: "+bstr[2]+"<br>"+"Account Name: "+bstr[3]+"<br>"+"Account Type: "+bstr[4]+"</div></html>");
        
         bankinfo=bstr[0]+"#"+bstr[1]+"#"+bstr[2]+"#"+bstr[3]+"#"+bstr[4];
    
        
            }
              NewSaleFrame.bankdetails=bankinfo;
...
NewSaleFrame.partygstcode=Integer.parseInt(substr1);
      ...
      //  NewPurchaseFrame.jComboBox4.setModel(new DefaultComboBoxModel<String>((String[]) centers.toArray(new String[0])));
        ...
        this.dispose();
        NewSaleFrame.partyselectionframevalue=0;
         }
...
NewSaleFrame.partygstcode=Integer.parseInt(substr1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalePartyNameSearchFilter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalePartyNameSearchFilter().setVisible(true);
            }
        });
    }
