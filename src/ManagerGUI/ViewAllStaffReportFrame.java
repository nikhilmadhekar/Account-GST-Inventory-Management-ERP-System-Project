 ...
 * @author welcome
 */
public class ViewAllStaffReportFrame extends javax.swing.JFrame {
   // private Button button;
     ...
     */
    public ViewAllStaffReportFrame() {
        
        super ("VIEW ALL STAFF REPORT Login By"+" "+LoginFrame.uname);
        initComponents();
      ...
      // columnModel.getColumn(7).setPreferredWidth(200);
         ...
         jTable1.setRowHeight(35);
             ...
             int rowheight=35;
             ArrayList staffinfo=new ManageProfileDBOperation().getAllStaffReportInfo();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Login Date & Time", "Logout Date & Time"
            }
        ) {
        ...
        jScrollPane1.setBounds(220, 170, 970, 200);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllStaffReportFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllStaffReportFrame().setVisible(true);
            }
        });
    }
